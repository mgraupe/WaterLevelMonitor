...
class jsnsr0t4:
    ...
    def readJSNSR0T4(self):
        ...
        (hist, bin_edges) = np.histogram(depthClean, 20,range=(np.median(depthClean)-np.percentile(depthClean,40),np.median(depthClean)+np.percentile(depthClean,40)))  # histogram of depth measurments
